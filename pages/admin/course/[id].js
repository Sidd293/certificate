...
const Edit = ({ existingData }) => {
  ...
  React.useEffect(() => {
    const {id, title, overview, price, duration, lessons, category } = course;
    const isCourse = Object.values({ id, title, overview, price, duration, lessons, category }).every(el => Boolean(el))
