...
const appsettings = () => {
  ...
  const [chatBotActivation, setChatBotActivation] = useState("");
    ...
    const handleClick = async () => {
        ...
        const payload = { value };
        await axios.post(`${baseUrl}/api/v1/appsettings/chatBotState`, payload, {headers});
        getChatBotState();
    }
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td className="text-right">
                                                <Switch onChange={handleClick} checkedIcon={null} uncheckedIcon={null} checked={ chatBotActivation == "true" ? true : false } />
